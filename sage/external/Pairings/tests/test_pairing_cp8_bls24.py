...
from testvector_bls24_315_cp8d1_640 import testvector_bls24_315_cp8d1_640

from cost_pairing import cost_pairing_cp8_cp12

from test_pairing_cp8_bls12 import test_curve

if __name__ == "__main__":
    arithmetic(False)
    print("BLS24-315")
    for v in testvector_bls24_315_cp8d1_640:
        if v['pnbits'] <= 635:
            test_curve(v)
    print("##################################################")
