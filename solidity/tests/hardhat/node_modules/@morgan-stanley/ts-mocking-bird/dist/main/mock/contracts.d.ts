export declare type OperatorFunction<T, C extends ConstructorFunction<T>> = (value: IMocked<T, C>) => IMocked<T, C>;
export declare type MatchFunction<T> = (passedValue: T) => boolean;
export declare type FunctionsOnly<T> = Pick<T, {
...
export declare type ParameterMatcher<T> = IParameterMatcher<T> | MatchFunction<T> | T;
declare type FunctionOrConstructor = (new (...params: any[]) => any) | ((...params: any[]) => any);
export declare type FunctionParameterMatchers<T extends any[]> = {
...
export declare type ConstructorFunction<T> = (abstract new (...args: any[]) => T) | (new (...args: any[]) => T);
...
export interface IFunctionWithParametersVerification<P extends Array<any>, T, U extends LookupType, C extends ConstructorFunction<T> = never> extends IFunctionVerifier<T, U, C> {
    /**
...
export interface IStrictFunctionVerification<T, U extends LookupType, C extends ConstructorFunction<T> = never> extends IFunctionVerifier<T, U, C> {
    /**
...
export interface IMocked<T, C extends ConstructorFunction<T> = never> {
     ...
     * @param mockFunction
     */
    setupFunction<K extends keyof FunctionsOnly<T>>(functionName: K, mockFunction?: T[K]): IFunctionWithParametersVerification<FunctionParams<T[K]>, T, 'function', C>;
    /**
     ...
     * @param setter
     */
    defineProperty<K extends keyof T>(propertyname: K, getter?: () => T[K], setter?: (value: T[K]) => void): IFunctionVerifier<T, 'getter', C>;
    /**
     ...
     * @param mockFunction
     */
    setupStaticFunction<K extends keyof FunctionsOnly<C>>(functionName: K, mockFunction?: C[K]): IFunctionWithParametersVerification<FunctionParams<C[K]>, T, 'staticFunction', C>;
    /**
     ...
     * @param setter
     */
    defineStaticProperty<K extends keyof C>(propertyname: K, getter?: () => C[K], setter?: (value: C[K]) => void): IFunctionVerifier<T, 'staticGetter', C>;
    /**
     ...
     * @param functionName
     */
    withFunction<K extends keyof FunctionsOnly<T>>(functionName: K): IFunctionWithParametersVerification<FunctionParams<T[K]>, T, 'function', C>;
    /**
     ...
     * @param functionName
     */
    withStaticFunction<K extends keyof FunctionsOnly<C>>(functionName: K): IFunctionWithParametersVerification<FunctionParams<C[K]>, T, 'staticFunction', C>;
    /**
     ...
     * @param functionName
     */
    withStaticSetter<K extends keyof C>(propertyname: K): IFunctionWithParametersVerification<[C[K]], T, 'staticSetter', C>;
}
/**
