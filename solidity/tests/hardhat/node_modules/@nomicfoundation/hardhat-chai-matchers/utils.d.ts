 ...
 */
export declare function buildAssert(negated: boolean, ssfi: Ssfi): (condition: boolean, messageFalse?: string | (() => string) | undefined, messageTrue?: string | (() => string) | undefined) => void;
