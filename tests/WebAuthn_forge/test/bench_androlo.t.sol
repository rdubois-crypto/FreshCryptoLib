...
contract test_Androlo is Test {
  ...
  /// @dev See Curve.validateSignature
    function dummy_Signature(uint e, uint[2] memory rs, uint[2] memory  Q) internal  returns (bool) {
        uint n = nn;
        uint p = pp;
   ...
   uint[2] memory  dummy_rs=[0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364140, 0x7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF5D576E7357A4501DDFE92F46681B2070];
   uint dummy_e=0xEBFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364140;
   bool res;
   uint[2] memory Q=[0xc6047f9441ed7d6d3045406e95c07cd85c778e4b8cef3ca7abac09b95c709ee5, 0x1ae168fea63dc339a3c58419466ceaeef7f632653266d0e1236431a950cfe52a];
      checkpointGasLeft=gasleft() ;
    res= dummy_Signature(dummy_e,dummy_rs, Q);
