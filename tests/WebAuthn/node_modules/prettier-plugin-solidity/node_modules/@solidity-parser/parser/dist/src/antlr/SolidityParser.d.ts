...
export declare class SolidityParser extends Parser {
    ...
    static readonly RULE_mappingKeyName = 40;
    static readonly RULE_mappingValueName = 41;
    static readonly RULE_functionTypeName = 42;
    static readonly RULE_storageLocation = 43;
    static readonly RULE_stateMutability = 44;
    static readonly RULE_block = 45;
    static readonly RULE_statement = 46;
    static readonly RULE_expressionStatement = 47;
    static readonly RULE_ifStatement = 48;
    static readonly RULE_tryStatement = 49;
    static readonly RULE_catchClause = 50;
    static readonly RULE_whileStatement = 51;
    static readonly RULE_simpleStatement = 52;
    static readonly RULE_uncheckedStatement = 53;
    static readonly RULE_forStatement = 54;
    static readonly RULE_inlineAssemblyStatement = 55;
    static readonly RULE_inlineAssemblyStatementFlag = 56;
    static readonly RULE_doWhileStatement = 57;
    static readonly RULE_continueStatement = 58;
    static readonly RULE_breakStatement = 59;
    static readonly RULE_returnStatement = 60;
    static readonly RULE_throwStatement = 61;
    static readonly RULE_emitStatement = 62;
    static readonly RULE_revertStatement = 63;
    static readonly RULE_variableDeclarationStatement = 64;
    static readonly RULE_variableDeclarationList = 65;
    static readonly RULE_identifierList = 66;
    static readonly RULE_elementaryTypeName = 67;
    static readonly RULE_expression = 68;
    static readonly RULE_primaryExpression = 69;
    ...
    static readonly RULE_numberLiteral = 94;
    static readonly RULE_identifier = 95;
    static readonly RULE_hexLiteral = 96;
    static readonly RULE_overrideSpecifier = 97;
    static readonly RULE_stringLiteral = 98;
